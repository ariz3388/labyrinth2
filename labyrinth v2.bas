...
1580 PRINT CHR$($11)"{sh +}reverse on{sh -}f{sh +}reverse off{sh -}-move forwards one block;"
1590 PRINT CHR$($11)"{sh +}reverse on{sh -}l{sh +}reverse off{sh -}-turn left{sh +}sh space{sh -}90 degress;"
1600 PRINTCHR$($11)"{sh +}reverse on{sh -}r{sh +}reverse off{sh -}-turn right{sh +}sh space{sh -}90 degrees;"
1610 PRINT CHR$($11)"{sh +}reverse on{sh -}h{sh +}reverse off{sh -}-help!"
...
1680 IF Z$="a" OR Z$=CHR$($9D) GOTO 1730: REM TURN TO LEFT
1690 IF Z$="d" OR Z$=CHR$($1D) GOTO 1750: REM TURN TO RIGHT
1700 IF Z$="w" OR Z$=CHR$($91) GOTO 2210: REM STEP FOWARD
...
2380 GOTO 2400
2390 GOSUB 2160:PRINT"{sh +}up{sh -}{sh +}up{sh -}"CHR$($1D)CHR$($1D)"you're outside!"
2400 GOTO 1650
...
2510 PRINT CHR$($1D) CHR$($12)"{space*7}"CHR$($92)CHR$($A6);
...
2600 PRINT CHR$($A6)CHR$($12)"{space*7}"
2610 NEXT I
2620 FOR I=C1 TO C3
...
2970 IF I>12 THEN PRINT CHR$($12)"{space*3}" CHR$($A6) CHR$($92);: GOTO 2990
2975 REM DRAW CENTER PASSAGE AND PASSAGE TO LEFT
2980 PRINT "{space*3}" CHR$($12) CHR$($A6) CHR$($92);
...
3040 IF I>12 THEN PRINT CHR$($12)CHR$($A6)"{space*3}":GOTO 3060
...
3100 PRINT CHR$($12)"{space*3}"CHR$($CE);:GOTO 3130
...
3140 PRINT CHR$($12)"{space*14}";:REM ROW 2,3,4 IN THIS SECTION
...
3400 IF I>C7 THEN PRINT CHR$($12)"{space*2}"CHR$($92)CHR$($A6);:GOTO3420
3410 PRINT"{space*2}"CHR$($A6);
...
3470 IF I>C7 THEN PRINT CHR$($A6)CHR$($12)"{space*2}"CHR$($92):GOTO 3490
3480 PRINT CHR$($A6)
...
4460 IF E=C1 THEN PRINT CHR$($12)"{space*2}";:GOTO 4480
...
14160 PRINT"=========================":END
14200 IFX6=1 THEN locate 25,1:GOTO 14220
14210 PRINT"{home}{down*24}"
